...
CLASS zcl_cpm_00_http IMPLEMENTATION.
  ...
  METHOD get_html.
    ...
    rv_html =
      ...
      |<html>{ lv_n }| &&
      |<head>{ lv_n }| &&
      |  <title>CP/M on SAP HANA</title>{ lv_n }| &&
      ...
      |    h1 \{ color: #FFB000; text-shadow: 0 0 10px #FFB000; margin-bottom: 10px; \}{ lv_n }| &&
      |    #terminal-container \{ border: 2px solid #FFB000; border-radius: 8px; padding: 10px; background: #000; box-shadow: 0 0 20px rgba(255, 176, 0, 0.3); overflow: hidden; width: 90vw; max-width: 1200px; \}{ lv_n }| &&
      ...
      |    ::-webkit-scrollbar-thumb:hover \{ background: #FFB000; box-shadow: 0 0 8px #FFB000; \}{ lv_n }| &&
      ...
      |    .xterm-viewport::-webkit-scrollbar-track \{ background: #000; border-left: 1px solid #332200; \}{ lv_n }| &&
      |    .xterm-viewport::-webkit-scrollbar-thumb \{ background: linear-gradient(180deg, #443300 0%, #AA7000 50%, #443300 100%); border: 1px solid #FFB000; \}{ lv_n }| &&
      |    .xterm-viewport::-webkit-scrollbar-thumb:hover \{ background: #FFB000; box-shadow: 0 0 10px #FFB000, inset 0 0 5px #332200; \}{ lv_n }| &&
      |  </style>{ lv_n }| &&
      |</head>{ lv_n }| &&
      |<body>{ lv_n }| &&
      ...
      |      term.writeln('\\x1b[33mConnecting to CP/M...\\x1b[0m');| &&
